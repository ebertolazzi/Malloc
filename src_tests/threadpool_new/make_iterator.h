...
namespace threadpool {
     ...
     */
    template<class Function>
    impl::FunctionInputIteratorRange<Function>
    make_function_input_range(Function&& fun) {
      return impl::FunctionInputIteratorRange<Function>(std::forward<Function>(fun));
    }
     ...
     */
    template<class Function>
    impl::FunctionOutputIterator<Function>
    make_function_output_iterator(Function&& fun) {
      return impl::FunctionOutputIterator<Function>(std::forward<Function>(fun));
    }
